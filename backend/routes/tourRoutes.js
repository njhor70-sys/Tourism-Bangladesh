...
router.get("/seed", async (req, res) => {
  try {
    ...
    const tours = [
      { name: "Bandarban Hill Trek", location: "Bandarban", price: 4500, duration: "3 Days 2 Nights", image: "Images/bandarban.png", description: "Experience the serene hills and vibrant culture of Bandarban.", seats: 20, highlights: ["Nilgiri Peak", "Boga Lake", "Tribal Village", "Waterfall Trek"] },
